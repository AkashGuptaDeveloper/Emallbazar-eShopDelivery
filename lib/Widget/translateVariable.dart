...
const String ORDER_OVERVIEW = 'Order Overview';
...
const String SEND_REQUEST = 'Wallet Withdraw';
...
const String SHOW_TRANS = 'Wallet Transactions';
const String SHOW_REQ = 'Wallet Requests';
const String PENDING = 'Pending';
const String ACCEPTED = 'Accepted';
const String REJECTED = 'Rejected';
const String PREFER_DATE_TIME = 'Preferred Delivery Date/Time';
const String APP_MAINTENANCE = 'Under Maintenance';
const String MAINTENANCE_DEFAULT_MESSAGE = 'We will back soon...';
...
const String Acc_num = 'account number add';
const String IFSC = 'ifsc code add';
const String BK_Name = 'name add';
const String ACC_NAME = "Enter your account name";
const String ACC_NUMBER = "Enter your account number";
const String ACC_IFSC = "Enter your IFSC code";
const String WITHDRAW_AMOUNT = "Enter your amount";
